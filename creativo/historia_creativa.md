...
> - `[SLIDE X]` → cambiar al archivo indicado en el navegador
> - `[SEÑALAR]` → mover el cursor o señalar físicamente la pantalla
> - `[PAUSA]` → silencio intencional — no llenar con palabras
> - *Cursiva* → énfasis oral, tono más bajo, momento dramático
> - **Negrita** → énfasis oral, subir el tono

---

## SLIDE 1 — ECG `[slide1_ecg.html]`
### ⏱ 0:00 – 0:45 | "La línea que se aplana"

---

*[Abrir el ECG. No decir nada por 3 segundos. Dejar que el público vea la línea verde moverse y luego aplanarse.]*

"Esto no es un electrocardiograma de un hospital."
...
> Si alguien pregunta, estos son los números exactos de los archivos:

- **Total empresa 2022–2024:** $1,254,415 USD (sin outliers)
